...
/test run                     → 全量测试
<!-- IF:frontend -->
/test run frontend            → 前端全部测试
<!-- ENDIF:frontend -->
<!-- IF:backend-api -->
/test run backend unit        → 后端仅单元测试
/test run backend integration → 后端仅集成测试
<!-- ENDIF:backend-api -->
...
<!-- IF:frontend -->
- **frontend** → 使用 CLAUDE.md Testing 部分的前端测试命令
<!-- ENDIF:frontend -->
<!-- IF:backend-api -->
- **backend** → 使用 CLAUDE.md Testing 部分的后端测试命令
<!-- ENDIF:backend-api -->
- **文件路径** → 确认文件存在，然后：
